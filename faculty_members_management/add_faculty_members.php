...
include '../../connect-mysql.php';
    ...
    $sql = "SELECT AUTO_INCREMENT FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'c3spp' AND TABLE_NAME = 'faculty_members'";
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i>Add Faculty Members</div>
            <div class="card-body">
